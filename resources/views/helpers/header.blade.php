            ...
            <?php if(Auth::check()){ ?>
                <li class="name">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/profile/signed">Мои События</a></li>
                        <li><a href="/profile/moderated">Подтвержденные</br> События</a></li>
                        <li><a href="/profile/completed">Завершенные События</a></li>
